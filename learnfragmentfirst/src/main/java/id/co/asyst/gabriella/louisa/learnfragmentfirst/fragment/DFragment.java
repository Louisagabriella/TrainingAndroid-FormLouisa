 ...
 */
public class DFragment extends Fragment implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    public static DFragment newInstance(String name, String address, String birthdate) {
